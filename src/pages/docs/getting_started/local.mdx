...
set up a few services and variables.
...
Inside, there are four scripts that help you with the lifecycle of this web application.
...
Once done, run shutdown.sh to stop all running services. You do not have to set
the application back up again after it has been stopped; just run run.sh to start it back up.